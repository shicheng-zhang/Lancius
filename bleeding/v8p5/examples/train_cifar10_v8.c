...
int main() {
    srand(42);
    printf("================================================================\n");
    printf("  BASIS V10: CIFAR-10 Notepad (Same Padding + He Init)         \n");
    printf("================================================================\n\n");
    ...
    v8_node* C1 = v8_conv2d(g, X, W1, 1, 2); // N x 16 x 32 x 32
    v8_node* R1 = v8_relu(g, C1);
    v8_node* P1 = v8_maxpool2d(g, R1, 2, 2); // N x 16 x 16 x 16

    v8_node* W2 = v8_input_4d(g, 32, 16, 5, 5);
    v8_node* C2 = v8_conv2d(g, P1, W2, 1, 2); // N x 32 x 16 x 16
    v8_node* R2 = v8_relu(g, C2);
    v8_node* P2 = v8_maxpool2d(g, R2, 2, 2);  // N x 32 x 8 x 8

    v8_node* F = v8_flatten(g, P2); // N x 2048

    // V10: Expanded FC1 (2048 -> 120)
    v8_node* W3 = v8_input(g, 2048, 120);
    ...
    v8_arena* scratch = v8_arena_create(512 * 1024 * 1024);
