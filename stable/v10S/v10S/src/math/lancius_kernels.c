        ...
        for(size_t co=0; co<C_out; co++) {
            for(size_t ho=0; ho<H_out; ho++) {
                for(size_t wo=0; wo<W_out; wo++) {
                    ...
                    // V10S FUSION: Apply ReLU immediately before writing to memory
                    size_t out_idx = ni*(C_out*H_out*W_out) + co*(H_out*W_out) + ho*W_out + wo;
...
// =====================================================================
// V10S TRANSFORMER MANDATE: LLM MATH KERNELS
// =====================================================================
...
// =====================================================================
// V10S TRANSFORMER MANDATE: MULTI-HEAD ATTENTION (CAUSAL)
// =====================================================================
...
// =====================================================================
// V10S TRANSFORMER MANDATE: AUTOREGRESSIVE KV-CACHE ATTENTION
// =====================================================================
